...
# - $env:APP_INFORMATIONAL_VERSION will always be v"major.minor.patch[-suffix]"
...
$env:APP_VERSION = "$env:BUILD_VERSION.$env:APPVEYOR_BUILD_NUMBER"
...
Update-AppveyorBuild -Version "v$env:APP_VERSION$BUILD_SUFFIX"