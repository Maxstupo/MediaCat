namespace MediaCat.Core.Services.Localization {
    using System;
    ...
    public sealed class I18N : II18N {
        ...
        public string Locale {
            ...
            set {
                if (locale == value) {
                    Logger.Info("{newLocale} is the current locale. No action needed.", value);
        ...
        public string Variant {
            ...
            set {
                ...
                if (variantName == newValue) {
                    Logger.Info("{newVariant} is the current variant. No action needed.", newValue);
        ...
        public Language Language {
            ...
            set {
                ...
                if (lang != null && lang == value) {
                    Logger.Info("{newLanguage} is the current language. No action needed.", value);
