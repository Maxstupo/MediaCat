namespace MediaCat.Core.Utility {
    ...
    // Modified - original from: https://github.com/hey-red/MimeTypesMap/blob/3d93ed5d2530460de80b71f8a90910df11723d56/src/MimeTypesMap/MimeTypesMap.cs
    public static class MimeTypesMap {
        ...
        public static Dictionary<string, string> MimeTypes => mimeTypeMap.Value;

        public static string GetExtension(string mime) {
            string ext = mimeTypeMap.Value.FirstOrDefault(x => x.Value.Contains(mime)).Key;
        ...
        public static string GetMimeType(string fileName) {
            ...
            return mimeTypeMap.Value.TryGetValue(ext, out string result) ? result : defaultMimeType;
        }
